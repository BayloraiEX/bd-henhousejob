...
--HEN HOUSE ITEMS--
    ...
    hh_something_blue             = { name = 'hh_something_blue',      label = 'Something Blue',   weight = 125,        type = 'item',      image = 'hh_something_blue.png',   unique = false,  useable = true,  shouldClose = true,  description = 'Can you guess what it is?'},
    --INGREDIENTS--
